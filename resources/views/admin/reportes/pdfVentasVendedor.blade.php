...
<body>
    ...
    <table id="datos">
        ...
        <tr>
            <td style="font-Size: 24px"><b> Reporte de Ventas del  {{Carbon\Carbon::parse($fechaInicialf)->format('d-m-Y')}} al {{Carbon\Carbon::parse($fechaFinalf)->format('d-m-Y')}}</b></td>
        </tr>
        <tr>
            <td style="width:100%; text-align: left;">___________________________________________________________________</td>
        </tr>
        ...
        <table>
          ...
          <tr>
                @foreach($usuario as $u)
                      <td><b>Vendedor: {{$u->name}}</b></td>
                @endforeach
                @if($contador == 0)
                      <td><b>Todos los vendedores</b></td>
                @endif
          </tr>
          <tr>
            @foreach($territorio as $te)
                  <td><b>Territorio: {{$te->territorio}}</b></td>
            @endforeach
            @if($terri == 0)
                  <td><b>Todos los Territorios</b></td>
            @endif
          </tr>
        </table>
    <table id="datos">
      ...
      <tr>
          <td style="text-align: left;"><?php
                                            $a = $a + 1;
                                        echo $a;?></td>
          <td style="text-align: left;">{{$t->vendedor}}</td>
          <td style="text-align: left;"><?php $fecha = date("d/m/y", strtotime($t->fecha)); echo $fecha?></td>
          <td style="text-align: left;">{{$t->pedido}}</td>
          <td style="text-align: left;">{{$t->cliente}}</td>
          @if($terri == 0)
            <td style="text-align: left;">{{$t->territorio}}</td>
          @endif
      ...
      <tr>
          ...
          <td style="text-align: right;">Q.<?php echo number_format($total, 2, ".", ",");?></td>
      </tr>
      @else
        <tr>
            <td style="align=left">
    ...
    <table>
        <tr>
            <td style="text-align: left;">Total de Ventas: Q.<?php
    ...
    <table>
        ...
        @if($a->total > 0)
        <tr>
            <td style="text-align: left;">Abonos Recibidos: Q.<?php
              $numero =$a->total;
              echo number_format($numero, 2, ".", ",");
              ?></td>
        </tr>
        @else
        <tr>
            <td style="text-align: left;">Abonos Recibidos: Q.0.00</td>
        </tr>
        @endif
        @endforeach
    </table>
