...
<body>
    ...
    <table id="datos">
        <tr>
            ...
            <tr>
                  <td style="font-Size: 24px"><b> Reporte Liquidación Mensual - <?php
                  if($mes == 1)
                    echo "Enero";
                  else if ($mes == 2)
                    echo "Febrero";
    ...
    <table id="datos">
        ...
        <tr>
            <td style="text-align: left;">{{$p->fecha}}</td>
            <td style="text-align: left;">{{$p->clientes}}</td>
            <td style="text-align: left;">{{$p->pedido}}</td>
            <td style="text-align: right;">Q.<?php  echo number_format($p->total, 2, ".", ",") ?></td>
            <?php
            if ($p->total > 0) {
               $a += $p->total;
            }
        ...
        <tr>
          ...
          <td></td>
          <td><b>Total</b></td>
        <td style="text-align: right;"><b>Q.<?php  echo number_format($a, 2, ".", ",") ?><b></td>
        </tr>
    </table>
    <h1>Abonos</h1>
    <table id="datos">
        ...
        <tr>
            ...
            <td style="text-align: left;">{{$p->metodo}}</td>
            <td style="text-align: right;">Q.<?php  echo number_format($p->total, 2, ".", ",") ?></td>
            <?php $b += $p->total  ?>
        </tr>
        @endforeach
        <tr>
          ...
          <td></td>
          <td><b>Total</b></td>
        <td style="text-align: right;"><b>Q.<?php  echo number_format($b, 2, ".", ",") ?><b></td>
        </tr>
    </table>
<footer>
