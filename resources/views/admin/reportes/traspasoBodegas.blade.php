...
<div id="modal_traspasoBodegas" class="modal fade" role="dialog">
  <form method="POST" id="ventasVendedor"  action="{{route('reportes.traspasoBodega')}}">
    <div class="modal-dialog">

      <!-- Modal content-->
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Reporte de traspaso a bodegas</h4>
        </div>
  ...
  <script>
          ...
          $('#modal_traspasoBodegas').on('show.bs.modal', function(e) {
