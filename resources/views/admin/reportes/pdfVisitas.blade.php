...
<body>
    ...
    <table id="datos">
        <tr>
            <td style="width:100%; text-align: left;">______________________________________________________________________________________________________________</td>
        </tr>
        <tr>
            <td style="font-Size: 32px"><b> Reporte de Visitas {{$fechaformateada}}</b> </td>
        </tr>
        <tr>
            <td style="width:100%; text-align: left;">______________________________________________________________________________________________________________</td>
        </tr>
    ...
    <table id="datos">
        ...
        <tr>
            ...
            <td style="text-align: left;">{{$v->direccion}}</td>
            <td style="text-align: left;">{{$v->observaciones}}</td>
            @if($usua[0]->id ==2)
            <td style="text-align: left;">{{$v->hora}}</td>
            @endif
        </tr>
        @endforeach
    </table>
    <table>
        ...
        @else
        <tr>
            <td style="text-align: left;">Total de Ventas: Q.0.00</td>
        </tr>
        @endif
        @endforeach
    </table>
...
<footer>
    <b>Fecha y Hora de Emisión: <?php echo date("d-m-Y H:i:s");?></b>
</footer>
</body>
