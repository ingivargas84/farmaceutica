...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg"><b>EL ANGEL</b></span>
    </a>
...
<script>
  ...
  document.onkeydown = function(e) {
    ...
    alertify.defaults = {
        ...
        // notifier defaults
        notifier:{
            // augto-dismiss wait time (in seconds)
            delay:5,
            // default position
...
@include('admin.reportes.reportes')
@include('admin.reportes.ventas')
@include('admin.reportes.saldoProveedores')
@include('admin.reportes.reporteCompras')
@include('admin.reportes.traspasoBodegas')
@include('admin.reportes.reporteMes')
@include('admin.reportes.modalLiquidacion')
@include('admin.reportes.reporteGanancias')
@include('admin.reportes.reportesAbonosClientes')
@include('admin.devoluciones.modalDevoluciones')
@include('admin.reportes.reportesSaldosTerritorio')
