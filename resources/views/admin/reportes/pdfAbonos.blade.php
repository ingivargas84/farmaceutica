...
<body>
    ...
    <table id="datos">
        ...
        <tr>
            <td style="font-Size: 24px"><b> Reporte de Abonos del  {{Carbon\Carbon::parse($fechaInicialf)->format('d-m-Y')}} al {{Carbon\Carbon::parse($fechaFinalf)->format('d-m-Y')}}</b></td>
        </tr>
        <tr>
            <td style="width:100%; text-align: left;">___________________________________________________________________</td>
        </tr>
    ...
    <table id="datos">
      ...
      <tr>
          <td style="text-align: left;"><?php
                                            $a = $a + 1;
                                        echo $a;?></td>
          <td style="text-align: left;">{{$ab->usuario}}</td>
          <td style="text-align: left;"><?php $fecha = date("d/m/y", strtotime($ab->fecha)); echo $fecha?></td>
          <td style="text-align: left;">{{$ab->cliente}}</td>
          <td style="text-align: left;">{{$ab->documento}}</td>
          <td style="text-align: right;"><b>Q.<?php
            $numero = $ab->monto;
      ...
      <tr>
          ...
          <td style="text-align: right;"><b>Q.<?php echo number_format($total, 2, ".", ",");?></b></td>
      </tr>
      @else
      <tr>
          <td style="align=left">
    ...
    <table>
        @if($total > 0)
        <tr>
            <td style="text-align: left;"><b>Abonos Recibidos: Q.<?php
              echo number_format($total, 2, ".", ",");
              ?></b></td>
        </tr>
        @else
        <tr>
            <td style="text-align: left;"><b>Abonos Recibidos: Q.0.00</b></td>
        </tr>
        @endif
    </table>
<footer>
