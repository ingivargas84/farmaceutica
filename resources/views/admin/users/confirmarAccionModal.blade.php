      ...
      <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel">Desea continuar con la desactivación?</h4>
            </div>
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btn btn-primary" id="btnConfirmarAccion" >Desactivar</button>
            </div>
          </div>
        </div>
    </form>
