...
<body>
    ...
    <table id="datos">
        ...
        <tr>
              <td style="font-Size: 24px"><b> Reporte de ganacias del {{$fechaInicialf}} al {{$fechaFinalf}}</b></td>
        </tr>
        <tr>
            <td style="width:100%; text-align: left;">___________________________________________________________________</td>
        </tr>
    ...
    <table id="datos">
        ...
        <tr>
            ...
            <td style="text-align: left;">{{$v->cantidad}}</td>
            <td style="text-align: right;"><b>Q.<?php  echo number_format($c->precio, 2, ".", ",") ?></b></td>
            <td style="text-align: right;"><b>Q.<?php  echo number_format($v->precio, 2, ".", ",") ?></b></td>
            <td style="text-align: right;"><b>Q.<?php $ventasv = $v->cantidad * $c->precio;
            echo number_format($ventasv, 2, ".", ",");?></b></td>
            <td style="text-align: right;"><b>Q.<?php  echo number_format($v->subtotal, 2, ".", ",") ?></b></td>
             <td style="text-align: right;"><b>Q.<?php $utilidad = $v->subtotal - $ventasv ;
        ...
        <tr>
          ...
          <td style="text-align: left;"></td>
          <td style="text-align: left;"></td>
          <td style="text-align: left;"><b>Total Utilidades</b></td>
          <td style="text-align: left;"><b>Q.<?php  echo number_format($t, 2, ".", ",") ?></b></td>
        </tr>
    </table>
<footer>
