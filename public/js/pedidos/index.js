var pedidos_table = $('#pedidos-table').DataTable({
...

    {
        ...
        "render": function (data, type, full, meta) {
            ...
            if (full.nota_envio !== null && full.estado_nota == 1) {
                return "<div id='" + full.id + "' class='text-center'>" +
                    "<div class='float-left col-lg-6'>" +
                    "<a href='#' id='report' >" +
                    "<i class='fas fa-file-download' title='Descargar reporte del pedido'></i>" +
                    "</a>" + "</div>" +
                    "<div class='float-left col-lg-6'>" +
                ...
                return "<div id='" + full.id + "' class='text-center'>" +
                    ...
                    "<i class='fas fa-trash-alt' title='Eliminar Pedido'></i>" +
                    "</a>" + "</div></div>";
            }
        },
...
$(document).on('click', '#report', function () {
    ...
    var row_data = pedidos_table.row($(this).closest('tr')).data();
        ...
        success: function (data) {
            ...
            var dd = {
                content: [
                    ...
                    { text: "\n" },
                    { text: "Pedido No." + row_data.no_pedido, style: 'titulo' },
                    { text: "\n" },
                    {
                        columns: [
                            {
                    ...
                    { text: "\n" },
                    {
                        columns: [
                            ...
                            {
                                text: "Q." + parseFloat(row_data.total).toFixed(2),
                            },
                        ]
                    },
                    { text: "\n" },
                    ...
                    table(
                        ...
                        { text: 'Cantidad', bold: 'true',  alignmentChild: 'center', alignment: 'center'},
                        { text: 'Precio', bold: 'true', alignmentChild: 'right', alignment: 'right'},
            ...
            pdfMake.createPdf(dd).download('El Angel - Pedido' + ' ' + row_data.no_pedido);
        },
        error: function () {
