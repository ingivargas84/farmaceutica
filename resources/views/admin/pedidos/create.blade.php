...
@section('header')
    <section class="content-header">
        <h1>
          PEDIDOS
            <small>Registrar un Pedido a la bodega {{$bodega->nombre}}</small>
        </h1>
        <ol class="breadcrumb">
                    ...
                    <div class="box-body">
                            ...
                            <div class="col-sm-3">
                                ...
                                <select name="cliente_id" class="form-control" id="clientes" autofocus tabindex="1">
                                    ...
                                    @foreach ($clientes as $cliente)
                                        <option value="{{$cliente->id}}">{{$cliente->territorio}} - {{$cliente->nombre_cliente}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-sm-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input type="hidden" class="form-control customreadonly" name="serie" id="serie" placeholder="Serie de la Factura">
                            </div>
                            <div class="col-sm-3">

                                <input type="hidden" class="form-control customreadonly" name="no-factura" id="no-factura" placeholder="No. de la Factura">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
